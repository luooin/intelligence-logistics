...
public class YuangongController {
    ...
    public R register(@RequestBody YuangongEntity yuangong){
    	...
    	YuangongEntity user = yuangongService.selectOne(new EntityWrapper<YuangongEntity>().eq("yuangonggonghao",
				yuangong.getYuangonggonghao()));
		if(user!=null) {
    ...
    public R save(@RequestBody YuangongEntity yuangong, HttpServletRequest request){
    	...
    	YuangongEntity user = yuangongService.
				selectOne(new EntityWrapper<YuangongEntity>().eq("yuangonggonghao", yuangong.getYuangonggonghao()));
		if(user!=null) {
